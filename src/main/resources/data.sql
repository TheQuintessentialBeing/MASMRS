...
select * from nowdb.records;
delete  from nowdb.records;
select * from nowdb.records;
-- parent table
...
-- Records data for from 2014 at least 3 students in each section ( section varies by year ) and for 3 subjects
